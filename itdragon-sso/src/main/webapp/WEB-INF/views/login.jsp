		...
		<div class="wrapper">
			<div class="container">
				...
				<form method="post" onsubmit="return false;" class="form">
					...
					<input type="hidden" value="${redirect}" name="redirect" placeholder=""/>
		...
		<script type="text/javascript">
			...
			function doLogin() {
				$.post("/user/login", $(".form").serialize(),function(data){
					if (data.status == 200) {
						if (redirectUrl == "") {
							location.href = "http://sso.client1.com:8082";
						} else {
						    console.log("login sso success, now redirect:", redirectUrl);
						    console.log(data)
							console.log(data.data)
							location.href = redirectUrl + "?token=" + data.data;
						}
					} else {
